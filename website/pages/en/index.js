...
const ProjectTitle = props => (
  <h2 className="projectTitle">
    <img src="img/scalacenter2x.png" />
    <em>Scala</em><i>fix</i>
    <small>{siteConfig.tagline} for <em>Scala</em></small>
  </h2>
);
...
class Terminal extends React.Component {
  render() {
    return (
      <div className="terminal_window terminal_window_full">
        <header>
...
class Highlight extends React.Component {
  render () {
    ...
    return (
      <pre className="{this.props.lang} hljs" ref={this._ref}>
